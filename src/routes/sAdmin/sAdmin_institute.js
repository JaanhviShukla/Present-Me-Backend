...
const { getAllInstitutions, updateInstitutionStatus } = require("../../services/institutionService");
...
sAdminRouter.patch("/sadmin/institutes/:institutionId/status", SAuth,async (req, res) => {
  try {
